...
parser.add_argument("--muon-orthogonalization", "--muon_orthogonalization", type=str, default="polar_express", choices=["polar_express", "newton_schulz", "adaptive_poly", "gso", "adaptive_greedy", "muon_adhoc"], help="orthogonalization method for Muon updates")
...
if args.optimizer == "adamw_muon" and args.ns_steps < 1:
...
if device_type != "cpu": # torch.compile on CPU is currently very slow and not worth it
