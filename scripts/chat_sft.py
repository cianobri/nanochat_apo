...
parser.add_argument("--muon-orthogonalization", "--muon_orthogonalization", type=str, default=None, choices=["polar_express", "newton_schulz", "adaptive_poly", "ls2", "gso", "adaptive_greedy", "muon_adhoc", "uagq"], help="orthogonalization method for Muon updates (default: inherit from pretrain)")
...
if args.load_optimizer:
    ...
    if optimizer_data is not None:
        ...
        try:
            ...
            print0(f"WARNING: optimizer state was incompatible with --optimizer={args.optimizer}; starting with fresh optimizer ({e})")
        else:
