...
def test_adaptive_greedy_step_updates_tall_and_wide_params(ns_steps):
    torch.manual_seed(0)
    ...
    optimizer = MuonAdamW([
        dict(
            ...
            orthogonalization="adaptive_greedy", muon_norm_iters=True,
        ...
        dict(
            ...
            orthogonalization="adaptive_greedy", muon_norm_iters=False,
